...
### Technical Design Document v0.3 -- FINAL SPEC
...
**v0.3 (final)** incorporates two additional engineering reviews and all outstanding design decisions.
...
def select_signals(
    ...
    4. GUARDRAILS:
       ...
       - A lightweight toxicity/defamation check runs on all selected
         signal summaries before injection.
