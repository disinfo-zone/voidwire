...
down_revision: str | None = "003_subscriptions"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint(
            "user_id", "tier", "date_context", name="uq_personal_reading_user_tier_date"
        ),
    )
    op.create_index(
        "idx_personal_readings_user_date", "personal_readings", ["user_id", "date_context"]
    )
